...
export const metadata: Metadata = {
  ...
  description: 'Datenschutzerklärung von Praktikumsgenie.de',
};
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-3xl mx-auto px-4 pt-28 pb-16">
        ...
        <h2 className="text-xl font-semibold mt-8 mb-2">8. KI-Praktikumsfinder</h2>
        <p>
        ...
        <p>
          ...
          <a href="https://stripe.com/de/privacy" target="_blank" rel="noopener noreferrer" className="text-emerald-600 hover:underline">
