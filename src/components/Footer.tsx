      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-7 gap-8">
          ...
          <div className="col-span-2 md:col-span-3 lg:col-span-2">
            <div className="flex items-center gap-2.5 text-white mb-3">
              <div className="w-7 h-7 rounded-md bg-gradient-to-br from-rose-500 to-pink-600 flex items-center justify-center">
            ...
            <div className="flex gap-3">
              <a href="https://instagram.com/praktikumsgenie" target="_blank" rel="noopener noreferrer" className="hover:text-rose-400 transition-colors" aria-label="Instagram">
              ...
              <a href="https://tiktok.com/@praktikumsgenie" target="_blank" rel="noopener noreferrer" className="hover:text-rose-400 transition-colors" aria-label="TikTok">
              ...
              <a href="https://youtube.com/@praktikumsgenie" target="_blank" rel="noopener noreferrer" className="hover:text-rose-400 transition-colors" aria-label="YouTube">
          ...
          <div>
            ...
            <ul className="space-y-1.5 text-sm">
              ...
              <li><Link href="/praktikumsarten" className="text-rose-400 hover:text-rose-300 font-medium transition-colors">Alle Praktikumsarten &rarr;</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-1.5 text-sm">
              ...
              <li><Link href="/ratgeber" className="text-rose-400 hover:text-rose-300 font-medium transition-colors">Alle Ratgeber &rarr;</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-1.5 text-sm">
              ...
              <li><Link href="/praktikum" className="text-rose-400 hover:text-rose-300 font-medium transition-colors">Alle Städte &rarr;</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-1.5 text-sm">
              <li><Link href="/stellen" className="hover:text-white transition-colors">Aktuelle Stellen</Link></li>
              <li><Link href="/features" className="hover:text-white transition-colors">Features</Link></li>
              <li><Link href="/so-funktionierts" className="hover:text-white transition-colors">So funktioniert&apos;s</Link></li>
              <li><Link href="/fuer-betriebe" className="hover:text-white transition-colors">Für Betriebe</Link></li>
        ...
        <div className="mt-10 pt-8 border-t border-gray-800">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <a href="https://minijobgenie.de" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-gray-800 text-gray-300 hover:text-white hover:bg-gray-700 text-sm transition-colors">
